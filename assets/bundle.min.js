...
console.log("templates loaded"),this.__templates=this.__templates||{},this.__templates.person=Handlebars.template({1:function(e,n,a,s){var t;return'value="'+this.escapeExpression((t=null!=(t=n.money||(null!=e?e.money:e))?t:n.helperMissing,"function"==typeof t?t.call(e,{name:"money",hash:{},data:s}):t))+'"'},compiler:[6,">= 2.0.0-beta.1"],main:function(e,n,a,s){var t,l,p=n.helperMissing;return'<input type="text" maxlength="20" placeholder="'+this.escapeExpression((l=null!=(l=n.name||(null!=e?e.name:e))?l:p,"function"==typeof l?l.call(e,{name:"name",hash:{},data:s}):l))+'" >\n<span class="person-price">\n	$ <input type="number" placeholder="0" '+(null!=(t=(n.compare||e&&e.compare||p).call(e,null!=e?e.money:e,0,{name:"compare",hash:{operator:"!="},fn:this.program(1,s,0),inverse:this.noop,data:s}))?t:"")+' min="0" max="999999" pattern="[0-9]{10}">\n</span>\n<span class="status"></span>\n<span class="icon-remove"></span>'},useData:!0});
var Person=Backbone.Model.extend({defaults:{name:"Persona",money:0}});
var PersonCollection=Backbone.Collection.extend({model:Person});
var PersonCollectionView=Backbone.View.extend({el:"#appContainer",events:{"click .add":"addPerson","click .remove":"removeLastPerson","input .person-number":"personNumber"},initialize:function(){var e=this;this.model.on("add",function(n){var t=new PersonView({model:n});$("#peopleContainer").append(t.el),e.calculate(),e.statusMessageTrigger(),e.refreshPersonQuantity()},this),this.model.on("change",function(n){e.calculate(),e.statusMessageTrigger()}),Backbone.on("Person:modelDestroyed",function(n){e.refreshPersonQuantity(),e.calculate()})},render:function(){$("#peopleContainer").empty(),_.each(this.model.models,function(e,n){var t=new PersonView({model:e});$("#peopleContainer").append(t.el)}),this.refreshPersonQuantity(),this.statusMessageTrigger()},addPerson:function(){var e=new Person;this.model.add(e)},removeLastPerson:function(){var e=this.model.pop();e.destroy(),this.calculate(),this.statusMessageTrigger(),this.refreshPersonQuantity()},personNumber:function(){var e=$(".person-number"),n=e.val(),t=n-this.model.length,o=Math.abs(t);if(n>=50)return void e.val(this.model.length);if(t>0)for(var s=0;o>s;s++)this.addPerson();else if(0>t)for(var s=0;o>s;s++)this.removeLastPerson()},refreshPersonQuantity:function(){$('.people-quantity input[type="number"]').val(this.model.length)},calculate:function(){var e,n=$(".total-price span"),t=0;_.each(this.model.models,function(n,o){e=parseInt(n.get("money"),10),t+=e}),n.html(t)},statusMessageTrigger:function(){var e=$(".total-price p span").html()/this.model.models.length;Backbone.trigger("Person:changeTotal",{personTotal:e})}});
var PersonView=Backbone.View.extend({tagName:"li",className:"person",events:{'input input[type="number"]':"moneyChange",'input input[type="text"]':"nameChange","click .icon-remove":"removePerson"},template:__templates.person,initialize:function(){var e=this;this.render(),Backbone.on("Person:changeTotal",function(t){e.refreshStatus(t.personTotal)}),this.model.on("destroy",function(){e.remove()})},render:function(){return this.$el.html(this.template(this.model.toJSON())),this},moneyChange:function(){var e=this.$el.find('input[type="number"]').val();/^[0-9]+$/.test(e)?this.model.set({money:e}):this.$el.find('input[type="number"]').val(this.model.get("money"))},nameChange:function(){this.model.set({name:this.$el.find('input[type="text"]').val()})},refreshStatus:function(e){var t,n=this.$(".status"),s=this.model.get("money");n.attr("class","status"),s>e?(t=s-e,n.addClass("status-receive"),n.html("Recibe $"+t.toFixed(2))):e>s?(t=e-s,n.addClass("status-pay"),n.html("Paga $"+t.toFixed(2))):(n.addClass("status-ok"),n.html("Está hecho"))},removePerson:function(){var e=this;this.model.destroy({success:function(){e.remove(),Backbone.trigger("Person:modelDestroyed")}})}});
var AppRouter=Backbone.Router.extend({routes:{"":"index",person:"person"},initialize:function(){},index:function(){var e=new Person,n=new Person,o=new PersonCollection([e,n]),r=new PersonCollectionView({model:o});r.render(),$("main").append(r.el)},person:function(){console.log("AppRouter person")}});
Handlebars.registerHelper("compare",function(r,e,n){if(arguments.length<3)throw new Error("Handlerbars Helper 'compare' needs 2 parameters");var t=n.hash.operator||"==",o={"==":function(r,e){return r==e},"===":function(r,e){return r===e},"!=":function(r,e){return r!=e},"<":function(r,e){return e>r},">":function(r,e){return r>e},"<=":function(r,e){return e>=r},">=":function(r,e){return r>=e},"typeof":function(r,e){return typeof r==e}};if(!o[t])throw new Error("Handlerbars Helper 'compare' doesn't know the operator "+t);var u=o[t](r,e);return u?n.fn(this):n.inverse(this)});
$(function(){new AppRouter;Backbone.history.start({pushState:!0})});